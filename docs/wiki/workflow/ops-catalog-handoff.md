...
| 2026-09-19 | `GET /api/v2/config` | V21 `festival_links`, manifest `festivalLinks`·검증·import·rollback 복사·export, snapshot `FestivalHome`, `ConfigController`. OpenAPI provider 검증 포함 | FAQ·웰컴 데이·공지 URL은 확정 전이라 `null`이다. |
