# 기여 및 Pull Request 규칙 — 목차

제품 판단은 [AGENTS.md](AGENTS.md)를 따른다. 아래에서 작업 시점에 필요한 규칙만 읽는다.
...
- [검증 명령과 CI](docs/wiki/workflow/validation.md)

[작업별 읽기 표](docs/wiki/README.md) · [PR 템플릿](.github/PULL_REQUEST_TEMPLATE.md) ·
[위키 관리](docs/wiki/MAINTENANCE.md)
