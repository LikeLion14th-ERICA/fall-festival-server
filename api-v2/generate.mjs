...
for(const op of operations){
  ...
  if(op.operationId==='startStampParticipation')responses[201].headers['Set-Cookie']={schema:{type:'string'},description:'__Host-festival-stamp 익명 참여자 쿠키. Secure; HttpOnly; SameSite=Lax; Path=/; Max-Age 30일. 이미 참여 중이면 200과 함께 보내지 않는다.'};
