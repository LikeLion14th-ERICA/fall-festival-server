...
const inputExamples={CrowdingInput:{level:'CROWDED'},AvailabilityInput:{status:'ON_SALE'},ProductInput:productInput,NoticeInput:noticeInput,NoticeTranslationInput:{title:'개발용 제목',body:'개발용 본문'},StampReceiptVerificationInput:{code:'MOCK-RECEIPT-CODE'}};
