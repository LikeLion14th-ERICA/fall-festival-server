  ...
  const server=http.createServer(async(req,res)=>{
    ...
    try{
      ...
      if(req.method==='GET'&&url.pathname==='/__mock/assets/sample.svg'){
        res.writeHead(200,{...headers,'Content-Type':'image/svg+xml; charset=utf-8'});return res.end('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600"><rect width="800" height="600" fill="#e2e8f0"/><path d="M0 300H800M400 0V600" stroke="#94a3b8" stroke-width="4"/><text x="400" y="270" text-anchor="middle" font-family="sans-serif" font-size="36">MOCK ASSET</text><text x="400" y="340" text-anchor="middle" font-family="sans-serif" font-size="22">Not a real festival map or photo</text></svg>');
      }
