...
const providerTests = {
  ...
  collectStamp: provider('src/test/java/dev/espero/festival/web/StampCardFlowIntegrationTest.java', 'collectsOneStampPerBoothPerDayAndFourADay'),
...
const operationScenarios = {
  ...
  getArtistHyped: ['HTTP-05', 'HTTP-18'],
  postArtistHyped: ['HTTP-05', 'HTTP-18'],
  ...
  startStampParticipation: ['HTTP-06'],
  getStampCard: ['HTTP-06'],
  collectStamp: ['HTTP-06'],
