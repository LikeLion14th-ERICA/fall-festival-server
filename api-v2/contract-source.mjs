...
export const operations = [
  ...
  ['putAdminCrowding','PUT','/admin/crowding','Crowding','혼잡도 저장',['ADM-CROWD'],[],['normal','full','error'],'CrowdingInput'],
