...
export const schemas = {
  ...
  Goods: object({ id, contentLocale: enumeration(['ko', 'en', 'zh-Hans', 'ja'], '실제 응답에 쓰인 언어. 공지와 같은 대체 규칙.'), name: text('상품명'), description: optionalText, price: ref('Money'), optionMode: enumeration(['SINGLE', 'OPTIONS'], 'SINGLE은 단일 판매 상태, OPTIONS는 색상×사이즈 조합별 판매 상태'), colors: array(ref('GoodsColor'), 'SINGLE이면 []'), sizes: array(ref('GoodsSize'), 'SINGLE이면 []') }),
