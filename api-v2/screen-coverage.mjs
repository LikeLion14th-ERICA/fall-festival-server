...
export function buildCoverage(source,operations){
  ...
  for(const [screenId,id,label,target] of [['GOODS-DETAIL','GOODS-DETAIL-D08','실제 제공 조합','Goods.options'],['ADM-GOODS-PRODUCT-EDIT','ADM-GOODS-PRODUCT-EDIT-D08','실제 제공 조합','Goods.options'],['SHOW-TIMETABLE','SHOW-TIMETABLE-D07','반입 금지 물품 목록','ProhibitedItems.items'],['STAMP-REWARD','STAMP-REWARD-D02','수령 인증 결과','StampReceiptVerificationInput.code → StampReceiptVerification.verified']])data.push({id,screenId,label,target,owner:'API',wikiSource:wikiSource(screenId),requiredInScreen:'필수',sourceDecision:'위키 v5',sourceMaterial:'운영 자료 대기',pendingIds:''});
