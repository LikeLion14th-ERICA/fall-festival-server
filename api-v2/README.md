...
| [examples.json](examples.json) | 요청 헤더·본문·경로와 258개 응답 원문 |
...
- 스탬프는 안내만 조회합니다. 참여 시작·4칸 누적·수령·KST 날짜 초기화는 브라우저 상태이며 서버 참여 기록·중복 차단·상품 재고 API는 없습니다. START 전 기본 카메라 QR 직접 진입은 시작 화면으로 보내고 자동 시작·적립하지 않습니다.
