...
class AdminSessionControllerTest {
    ...
    void setUp() {
        ...
        controller = new AdminSessionController(service, new ApiMetaSupport(clock), clock);
    ...
    void meUsesAuthenticatedPrincipalWithoutParsingJwt() {
        ...
        AdminSessionController.AdminResponse result = controller.me(principal, request).data();
